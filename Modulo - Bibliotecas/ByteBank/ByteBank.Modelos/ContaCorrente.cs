...
namespace ByteBank.Modelos
{
    ...
    public class ContaCorrente : IComparable
    {
        ...
        /// </summary>
        /// <param name="agencia"> Representa o Valor Da Propriedade <see cref="Agencia"/> e deve possuir um valor > 0. </param>
        /// <param name="numero"> Representa o Valor Da Propriedade <see cref="Numero"/> e deve possuir um valor > 0. </param>
